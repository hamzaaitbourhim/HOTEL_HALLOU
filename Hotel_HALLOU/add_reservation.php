...
<div class='container'>
    <div class="card mx-auto col-md-5 col-8 mt-3 p-0"> <img class='mx-auto pic' src="<?php echo "assets/images/rooms/".$row['id'].".jpg"?>" alt="chambre" />
        ...
        <div class="card-body">
            ...
            <div class="numbr mb-3"> <i class=" col-1 fas fa-credit-card text-muted p-0"></i> <input class="col-10 p-0" name="start_date" type="date" placeholder="Date de Début"> </div>
            <div class="numbr mb-3"> <i class=" col-1 fas fa-credit-card text-muted p-0"></i> <input class="col-10 p-0" name="end_date" type="date" placeholder="Date de Fin"> </div>
        </div>
